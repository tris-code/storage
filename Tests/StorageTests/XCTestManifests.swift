...
extension SharedStorageTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__SharedStorageTests = [
        ("testInit", testInit),
        ("testSharedStorage", testSharedStorage),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(SharedStorageTests.__allTests__SharedStorageTests),
